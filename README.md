...
Please note that the Scratch trademarks, including the Scratch name, logo, the Scratch Cat and Gobo graphics, are property of MIT, and the use of the Marks is governed by [this](http://wiki.scratch.mit.edu/wiki/Scratch_1.4_Source_Code#Scratch_Trademark_Policy) policy.
