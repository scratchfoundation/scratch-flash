...
//		trace('uploadFromByteArray(vertexData, 0, 0, '+((indexData.length / 12) * 4)+')');
	...
	private var myMatrix:Matrix3D = new Matrix3D();
...
//		}
		...
		const dw:Number = bounds.width * localScale;
		const dh:Number = bounds.height * localScale;
