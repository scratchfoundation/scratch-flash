...
public final class BitmapPencilTool extends SVGTool {
	...
	override protected function init():void {
		super.init();
		Scratch.app.stage.addEventListener(MouseEvent.MOUSE_DOWN, mouseDown, false, 0, true);
		Scratch.app.stage.addEventListener(MouseEvent.MOUSE_MOVE, mouseMove, false, 0, true);
	...
	override protected function shutdown():void {
		Scratch.app.stage.removeEventListener(MouseEvent.MOUSE_DOWN, mouseDown);
		Scratch.app.stage.removeEventListener(MouseEvent.MOUSE_MOVE, mouseMove);
